...
/**
 * The event store (D7): append / read-stream / read-all behind a port so the SQLite adapter can
...
/** The durable reactor checkpoint (D8): last global_seq a consumer has processed. */
...
/** In-process publish-after-commit fan-out (D7); the durable catch-up path is `readAll`. */
