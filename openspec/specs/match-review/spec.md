...
- **THEN** the files are removed from intake, the import is terminal `rejected`, and a release verdict is recorded carrying the download id, the retained delivered copy, and the reasons
