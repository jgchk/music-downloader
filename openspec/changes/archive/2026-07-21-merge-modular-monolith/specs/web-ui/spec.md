...
The SvelteKit BFF web interface — the product's sole interface at functional parity with the retired MCP tools — its process shape, and its testing/coverage regime (design D8, D9, D10).
