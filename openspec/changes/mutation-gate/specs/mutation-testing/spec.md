...
Three of the requirements below — the changed-line gate, the suppression doctrine, and the
scope — were drafted before adoption measured what the tool can actually do on this repository.
They are stated here as what SHIPPED rather than as what was hoped for, once each rather than
twice; the reasoning is in `design.md` (D4a, D6, D7) and the burn-down section.
