 ...
 * Deliberately separate from {@link IdGenerator}: that one mints aggregate identities, and the two
 * formats must not drift into each other. Injected so every mint point stays deterministic under
 * test.
 *
