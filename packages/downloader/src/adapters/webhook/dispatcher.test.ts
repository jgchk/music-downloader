...
const URL = 'https://importer.example/hooks/music';
...
// fixedClock default: 2026-07-03T12:00:00.000Z → unix seconds
const NOW_SECONDS = String(Math.floor(new Date('2026-07-03T12:00:00.000Z').getTime() / 1000));
