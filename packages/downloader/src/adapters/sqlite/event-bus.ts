...
/**
 * The in-process publish-after-commit fan-out (D7): the event store publishes committed events
...
/**
 * `global_seq` polling catch-up (D7): drain every event after `fromGlobalSeq` in global order,
