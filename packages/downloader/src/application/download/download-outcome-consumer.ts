...
import type { TryResult } from '../ports/outbound-ports.js';
 ...
 */
export interface TryOutcomeDependencies extends CommandDependencies {
...
export function deliverDownloadOutcome(
  dependencies: TryOutcomeDependencies,
