          ...
          mutants: [
            {
              ...
              status: 'Survived',
              location: { start: { line: 182 }, end: { line: 182, column: 20 } },
              replacement: 'true',
            },
          ],
        },
          ...
          mutants: [
            {
              mutatorName: 'ConditionalExpression',
              status: 'Survived',
              location: { start: { line: 7 }, end: { line: 7, column: 20 } },
              replacement: 'true',
            },
            {
            ...
            },
            {
              ...
              status: 'Survived',
              location: { start: { line: 9 }, end: { line: 9, column: 20 } },
              replacement: 'false',
            },
          ],
        },
          ...
          mutants: [
            {
              ...
              status: 'NoCoverage',
              location: { start: { line: 3 }, end: { line: 3, column: 20 } },
              replacement: '{}',
            },
          ],
        },
        ...
        'a.ts': {
          mutants: [
            ...
            },
            {
              ...
              status: 'Ignored',
              location: { start: { line: 2 }, end: { line: 2, column: 20 } },
              replacement: '""',
            },
            {
          ...
          mutants: [
            {
              mutatorName: 'BooleanLiteral',
              status: 'Survived',
              location: { start: { line: 4 }, end: { line: 4, column: 20 } },
              replacement: 'false',
            },
          ],
        },
