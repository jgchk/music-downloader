...
/**
 * The published-event contract artifacts (change: acquisition-outbound-events): shared library for
...
export const publishedEventSchemas: readonly PublishedEventSchemaSource[] = [
  { type: ACQUISITION_FULFILLED_TYPE, schema: acquisitionFulfilledEventSchema },
];
